...
public class Alumno {
    ...
    public static String CENTROESTUDIO = "CAMPUSFP";
    ...
    //(2)CONSTRUCTOR(S): INICIALIZAR LOS VALORES DEL OBJETO
    ...
    public Alumno(int idAlumno, String nombre, int edad, double estatura, char sexo) {
        this.idAlumno = idAlumno;
        this.nombre = nombre;
        this.edad = edad;
        this.estatura = estatura;
    ...
    //(3)METODOS SET(PONER) Y GET(OBTENER)
